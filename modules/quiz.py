...
class QuizModule:
    ...
    def load_questions(self):
        ...
        return [
            ...
            {
                "id": 4,
                "question": "Welche Rolle spielt die Digitalisierung in der Eignungsdiagnostik?",
                "answer": "Die Digitalisierung ermöglicht Online-Assessments mit räumlicher und zeitlicher Flexibilität, bietet Kostenvorteile und erhöht die Objektivität durch standardisierte Auswertung."
            },
            {
                "id": 5,
                "question": "Was besagt das Bandbreiten-Fidelitäts-Dilemma?",
                "answer": "Es beschreibt den Kompromiss zwischen breiter Erfassung eines Konstrukts (Bandbreite) und präziser Messung (Fidelität) bei Testverfahren."
            }
        ]
